<?php
    ...
    <div class="w-50 mx-auto">
        ...
        <input class="form-control mb-3" type="date" name="dateNaissance" id="dateNaissance" value="<?=
        set_value('dateNaissance')?>"required>
        <?= $validation->getError('dateNaissance');?><br><br>

        <label class="form-label" for="password">Mot de passe:</label>
        <input class="form-control mb-4" type="password" name="password" id="password" value="
