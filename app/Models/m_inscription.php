...
class m_inscription extends \CodeIgniter\Model
{
    ...
    public function recupConcoursTournoi($support): bool | array
    {
        $db = db_connect();
    ...
    public function recupDateConcours($id): bool | array
    {
        $db = db_connect();
    ...
    public function recupUserInscription($id): bool | array
    {
        $db = db_connect();
        $builder = $db->table('inscription')->select('CodeReservation_inscription, 
        concours_SupportZone, Date_avoirLieu, concours_Nom')
    ...
    /// Récupération des tournois où il y a encore de la place, qui ont un PEGI > à l'âge de
    ///  l'utilisateur en fonction d'un support
    public function recupConcoursTournoiUser($support, $ageUser): bool | array
    {
        $db = db_connect();
        $builder = $db->table('concours')
            ->select('Id_concours, concours_Nom, Date_avoirLieu, SupportZone_zone, zone_NomZone, 
            avoirlieu_PlacesRestantes, avoirlieu_CodeReservation')
            ->join('avoirlieu', 'IdConcours_avoirLieu = Id_concours')
            ->join('zone', 'SupportZone_zone = concours_SupportZone')
    ...
    public function ajoutInscription($info): bool
    {
        $db = db_connect();
    ...
    public function suppInscription($id): bool
    {
        $db = db_connect();
        $builder = $db->table('inscription')
